...
public class Main {
    ...
    public void startup(String uriStudent, String uriMath, String uriChinese, String uriEnglish) throws IOException {
        ...
        mathScores.forEach((id, score) -> {
            //manager.findById(id).setMath(score);
        ...
        chineseScores.forEach((id, score) -> {
            //manager.findById(id).setChinese(score);
        ...
        englishScores.forEach((id, score) -> {
            //manager.findById(id).setEnglish(score);
...
//        });
    ...
    private List<Student> loadStudents(String uri) throws IOException {
